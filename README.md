...
![Dashboard Preview](https://github.com/Manojreddy544/Zomato-Restaurants-Expansion/blob/main/Dashboard%20Image.png)
...
|---------------------------------------------------|-----------------------------------------------------------------------------|
| `Zomato_Restaurants_Analysis_PPT.pptx`       | Executive presentation deck summarizing key insights and strategic findings |
| `Zomato_Restaurants_Analysis_Dashboard.xlsx`      | Interactive dashboard for exploring trends, filters, and KPIs               |
| `Dashboard Image.jpg`                             | Static preview of the Excel dashboard interface                          |
...
1. **Presentation Deck**  
   Review `Zomato_Restaurants_Analysis_PPT.pptx` for a high-level overview of key findings and strategic implications.
...
**Name**: Manoj Kumar Reddy <br>
**Email**: manojcse544@gmail.com <br>
**LinkedIn**: [linkedin.com/in/manoj544](https://www.linkedin.com/in/manoj544/)  <br>
**GitHub**: [github.com/Manojreddy544](https://github.com/Manojreddy544)<br>
